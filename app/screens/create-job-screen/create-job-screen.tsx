import { Form, Header, Icon, Input, Item, Picker, Text, Textarea, View } from 'native-base'
  ...
  return (
    <ScrollView style={styles.ROOT}>
      <Header transparent style={styles.header}>
        <TouchableOpacity onPress={() => navigation.navigate(screens.authenticated.company.profile)}>
          <Icon name='close-outline' style={{ color: color.brandLight }}></Icon>
        </TouchableOpacity>
        {/* <Text style={styles.headerTitle}>Create job</Text> */}
        <TouchableOpacity onPress={handleSave}>
          <Text style={{color: color['color-primary-600'], fontWeight: '700'}}>Add</Text>
        </TouchableOpacity>
      </Header>
      ...
      <Form style={{width: useWindowDimensions().width * 0.8}}>
          ...
          <Item style={styles.textInput}>
            ...
            <Input placeholder="Seniority Level" onChange={onSeniorityLevelChange}/>
          </Item>

          <Item style={styles.textInput}>
            <Icon style={styles.textInputIcon} name='earth-outline' />
            <Input placeholder="Recruiment URL" onChange={onRecruitmentUrlChange}/>
          </Item>

          <Item style={styles.textInput}>
            <Icon style={styles.textInputIcon} name='filter-outline' />
            <Input placeholder="Employment type" onChange={onEmploymentTypeChange}/>
          </Item>
          ...
          <SectionedMultiSelect
                  ...
                  onConfirm={() => {onSkillsChange(selectedItems.map(item => skillTag[item]))}}
                  renderSelectText = {() => {
