import { Button, Form, Header, Icon, Input, Item, Label, Text, Textarea, Thumbnail } from "native-base"
					...
					<View style={styles.topInfo}>
						...
						<View style={{ flexDirection: 'row', justifyContent: 'center' }}>
							<TouchableOpacity onPress={chooseFile}>
								<Thumbnail circular large style={styles.avatarUser} source={require("./company.jpg")}></Thumbnail>
							</TouchableOpacity>
						</View>
