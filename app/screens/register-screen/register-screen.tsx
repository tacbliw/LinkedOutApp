      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}> 
          ...
          <View style= {styles.rect}>
            <View style={styles.input}>
              ...
              <View style={styles.lineIcon}>
                <MaterialCommunityIconsIcon name="account-box-multiple"style={styles.icon}></MaterialCommunityIconsIcon>
                <View style={{}}>
                  <Picker 
                    mode="dropdown"
              ...
              <View style={styles.lineIcon}>
                <MaterialCommunityIconsIcon name="key-plus" style={styles.icon} ></MaterialCommunityIconsIcon>
                <TextInput
