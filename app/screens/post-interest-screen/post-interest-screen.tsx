            ...
            <Content padder>
                <Card transparent>
                    ...
                    <CardItem style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                        ...
                        <Text style={{ fontWeight: 'bold', fontSize: 20 }}>Native Base</Text>
                        <Text>NativeBase is a free and source framework that enable
                    ...
                    <CardItem style={{ flexDirection: 'column' }}>
                        <List
                            dataArray={datas}
                            renderRow={data =>
                                <ListItem noIndent style={{ borderBottomWidth: 1, marginBottom: 5, paddingTop: 0, paddingRight: 0, paddingLeft: 0, paddingBottom: 0 }}>
                                    <Comment avatar={data.img} name={data.text} content={data.note} time={data.time} />
                                </ListItem>
                            }
                        />
