...
import { FollowingScreen, ProfileCompanyScreen, SettingsScreen } from "../screens"
...
export function PrimaryUserNavigator() {
	return (
		...
		>
			...
			<Drawer.Screen name={screens.authenticated.user.profile} component={ProfileCompanyScreen} />
